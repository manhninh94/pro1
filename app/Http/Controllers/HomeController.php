...
class HomeController extends Controller
{
    ...
    {
        $this->server    = $server;
        $this->subdomain = Route::input('subdomain') == null ? 'home' : Route::input('subdomain');
        $temp            = json_decode($server->json('api/guests/cache', ['subdomain' => $this->subdomain]), true);
        $this->cache     = $temp;
        $this->country   = Route::input('country') == null ? 'vn' : Route::input('country');
    }
