...
<head>
    ...
    <link rel="icon" type="img/ico" href="{{(isset($shopData['favicon']) && isset(json_decode($shopData['favicon'])->image) && \App\Http\Helpers\BladeHelper::isImage(json_decode($shopData['favicon'])->image)) ? json_decode($shopData['favicon'])->image : url('/images/favicon.jpg')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/libs/jquery.bxslider/jquery.bxslider.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('assets/libs/owl.carousel/owl.carousel.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('assets/libs/fancyBox/jquery.fancybox.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('assets/libs/jquery-ui/jquery-ui.css')}}"/>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/style.css?version=1.0')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/responsive.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/custom.css?v=0.0')}}"/>

    @forelse($stylesheets as $url)
    <link href="{{ $url }}" rel="stylesheet" type="text/css" />
    @empty
    @endforelse

    <title>{{isset($shopData['title']) && $shopData['title']!=""? $shopData['title'] : 'Salevia'}} - {{ $title }}</title>
    <style>
...
@include('templates.blocks.header', ['keyword' => isset($keyword) ? $keyword : ''])
...
<footer id="footer">
    <div class="container">
        ...
        <div id="introduce-box" class="row">
            <div class="col-md-3">
                <div id="address-box">
                    <a href="{{url('/'.$country)}}"><img src="{{(isset($shopData['logo']) && isset(json_decode($shopData['logo'])->image) && \App\Http\Helpers\BladeHelper::isImage(json_decode($shopData['logo'])->image)) ? json_decode($shopData['logo'])->image : asset('/images/logo.png')}}" style="max-height: 110px; max-width: 270px;"  alt="Home page" /></a>
                    <div id="address-list">
        ...
        {{--<div id="trademark-box" class="row">--}}
            {{--<div class="col-sm-12">--}}
                {{--<ul id="trademark-list">--}}
                    ...
                    {{--<li>--}}
                        {{--<a href="#"><img src="{{asset('assets/data/trademark-ups.jpg')}}"  alt="ups"/></a>--}}
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="#"><img src="{{asset('assets/data/trademark-qiwi.jpg')}}"  alt="ups"/></a>--}}
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="#"><img src="{{asset('assets/data/trademark-wu.jpg')}}"  alt="ups"/></a>--}}
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="#"><img src="{{asset('assets/data/trademark-cn.jpg')}}"  alt="ups"/></a>--}}
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="#"><img src="{{asset('assets/data/trademark-visa.jpg')}}"  alt="ups"/></a>--}}
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="#"><img src="{{asset('assets/data/trademark-mc.jpg')}}"  alt="ups"/></a>--}}
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="#"><img src="{{asset('assets/data/trademark-ems.jpg')}}"  alt="ups"/></a>--}}
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="#"><img src="{{asset('assets/data/trademark-dhl.jpg')}}"  alt="ups"/></a>--}}
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="#"><img src="{{asset('assets/data/trademark-fe.jpg')}}"  alt="ups"/></a>--}}
                    {{--</li>--}}
                    {{--<li>--}}
                        {{--<a href="#"><img src="{{asset('assets/data/trademark-wm.jpg')}}"  alt="ups"/></a>--}}
                    {{--</li>--}}
                {{--</ul>--}}
            {{--</div>--}}
        {{--</div> <!-- /#trademark-box -->--}}
...
<script type="text/javascript" src="{{asset('assets/libs/jquery/jquery-ui.js')}}"></script>
...
<script type="text/javascript" src="{{asset('assets/libs/jquery.bxslider/jquery.bxslider.min.js')}}"></script>
...
<script type="text/javascript" src="{{asset('assets/libs/fancyBox/jquery.fancybox.js')}}"></script>

<script type="text/javascript" src="{{asset('assets/libs/jquery.elevatezoom.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/js/theme-script.js?v=1.0.3')}}"></script>
    ...
    $(function(){
        ...
        $(window).load(function() {
            ...
            $('.check-image').each(function(){
                var noimage = $(this).data('no-image'),
                    image = $(this).attr('src');
                if( checkimage(image) !== true) $(this).attr('src', noimage);

            });

         });

        function checkimage(argument) {
            var image = new Image(); 
            image.src = argument;
            if (image.width == 0) {
              return false;
